...
void MoAnimationController::Read(BinaryReader * r, ModelAnimationController * modelSkeleton)
{
}

void MoAnimationController::Write(BinaryWriter * w, ModelAnimationController * modelSkeleton)
{
}
