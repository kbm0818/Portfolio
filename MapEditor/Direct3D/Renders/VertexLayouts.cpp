...
D3D11_INPUT_ELEMENT_DESC VertexColorTexture2Normal::desc[] =
{
	...
	{ "COLOR", 0, VERTEX_RGBA, 0, ALIGNED_ELEMENT, VERTEX, 0 },
	{ "TEXCOORD", 0, VERTEX_RG, 0, ALIGNED_ELEMENT, VERTEX, 0 },
	{ "TEXCOORD", 1, VERTEX_RG, 0, ALIGNED_ELEMENT, VERTEX, 0 },
	{ "NORMAL", 0, VERTEX_RGB, 0, ALIGNED_ELEMENT, VERTEX, 0 },
};
UINT VertexColorTexture2Normal::count = 5;
...
VertexColorTexture2Normal::VertexColorTexture2Normal(D3DXVECTOR3 position, D3DXCOLOR color, D3DXVECTOR2 uv, D3DXVECTOR2 uv2, D3DXVECTOR3 normal)
{
	this->position = position;
	this->color = color;
	this->uv = uv;
